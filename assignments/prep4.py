...
As you complete your work in this file, delete eac comment.
...
class Tree:
    ...
    def maximum(self: Tree) -> int:
        ...
        if self.is_empty():
            ...
            m = max(subtree._root for subtree in self._subtrees)
            return max(m, self._root)
    ...
    def __contains__(self, item: Any) -> bool:
        ...
        if self.is_empty():
            ...
            return self._root == item or any(subtree.__contains__(item)
                                             for subtree in self._subtrees)
